...
describe('Events Reducer', () => {
  ...
  it('should update event successfully', () => {
    ...
    expect(state.allEvents[0].title).toBe('Updated Title');
  });
  ...
  it('should update odds', () => {
    ...
    expect(state.allEvents[0].odds.home).toBe(2.5);
    expect(state.allEvents[0].odds.draw).toBe(3.5);
    expect(state.allEvents[0].odds.away).toBe(2.8);
  });
